...
1. :speech_balloon: **Ask internal Slack channel**, you may ask for help in there, following [code of conduct](https://globant.enterprise.slack.com/archives/C05TX89RJAY).

1. :question: As a **last resort**, you may open an issue on GitHub to ask for help. However, please clearly explain what you are trying to do, and list what you have already attempted to solve the problem. Provide code samples, but **do not** attach your entire project for someone else to debug. Review our [contributing guidelines](https://github.com/U9-GLO297-CW/dojo-challenge-gregorio-ayvar/blob/main/.github/CONTRIBUTING.md).
